/* ═══════════════════════════════════════════════════════
   api.js — PSX Watch data layer
   Currently uses mock data. Replace fetchStockData() and
   fetchPayoutData() with real API calls when available.

   Possible real sources to integrate later:
   - PSX official site scraping via background service worker
   - unofficial PSX APIs (e.g. mettastock, investorlounge)
   - Firebase Functions as a proxy
   ═══════════════════════════════════════════════════════ */
